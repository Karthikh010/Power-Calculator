    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins" id="bgImg">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Low Tension-II Colonies (LT-II)</h2>
                        <?php
                        ...
                        <form name='select-form2' method="POST">
                            <input Type="text" name="sp" value="<?php echo $row1['SFIX'] ; ?>" hidden>
                        ...
                        <?php
                            if(isset($_POST['update']))
                            {
                                ...
                                $erate = $_POST['erate'];
                                $sp = $_POST['sp'];
                                $sql2="update tharif2 set SFIX='$sfix', TFIX='$tfix', ERATE='$erate' where SFIX='$sp' ";
