    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins" id="bgImg">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Low Tension - I- Domestic (LT-I)</h2>
                    <form name='select-form' method="POST" >
                            ...
                            <div class="rs-select2 js-select-simple select--no-search">
                                ...
                                <?php
                                 ...
                                 if(!$conn)
                                  ...
                                  $sql = "select CONSMIN, CONSMAX from tharif1 ";
                        ...
                        <?php
                            if(isset($_POST['select']))
                            {
                                ...
                                $sql1 = "select CONSMIN, CONSMAX, SFIX, TFIX, ERATE from tharif1 where CONSMAX='$consmax' ";
                        ...
                        <div class="input-group">
                            ...
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="typ" required >
                                    ...
                                    <option value="2">Non Telescopic</option>  
                                </select>
                                <div class="select-dropdown"></div>
                            </div>
                        </div>
                        ...
                        <?php
                            if(isset($_POST['update']))
                            {
                                ...
                                if($typ == 1)
                                {
                                    $sql2="update tharif1 set CONSMIN='$minc', CONSMAX='$maxc', SFIX='$sfix', TFIX='$tfix', ERATE='$erate', TELES='1', NONTELES='0' where CONSMAX='$consmax' ";
                                }
                                else
                                {
                                    $sql2="update tharif1 set CONSMIN='$minc', CONSMAX='$maxc', SFIX='$sfix', TFIX='$tfix', ERATE='$erate', NONTELES='1', TELES='0' where CONSMAX='$consmax' ";
                                }
