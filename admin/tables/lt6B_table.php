    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins" id="bgImg">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">LT - VI General (B)</h2>
                    <form name='select-form' method="POST" >
                            ...
                            <div class="rs-select2 js-select-simple select--no-search">
                                ...
                                <?php
                                 ...
                                 if(!$conn)
                                  ...
                                  $sql = "select CONSMIN, CONSMAX from tharif6 where SELTABLE = '2' ";
                        ...
                        <?php
                            if(isset($_POST['select']))
                            {
                                ...
                                $sql1 = "select CONSMIN, CONSMAX, FIXED, ERATE from tharif6 where CONSMAX='$consmax' and SELTABLE = '2' ";
                        ...
                        <?php
                            if(isset($_POST['update']))
                            {
                                ...
                                $erate = $_POST['erate'];
                                $consmax = $_POST['cons'];
                                $sql2="update tharif6 set CONSMIN='$minc', CONSMAX='$maxc', FIXED='$fixed', ERATE='$erate' where CONSMAX='$consmax' and SELTABLE = '2' ";
