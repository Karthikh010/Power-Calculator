    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins" id="bgImg">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">LT-IX —Display Lighting and Hoardings</h2>
                        <?php
                        ...
                        <form name='select-form2' method="POST">
                            <input Type="text" name="fixed" value="<?php echo $row1['FIXED'] ; ?>" hidden>
                        ...
                        <?php
                            if(isset($_POST['update']))
                            {
                                ...
                                $erate = $_POST['erate'];
                                $fixed = $_POST['fixed'];
                                $sql2="update tharif9 set FIXED='$fix', ERATE='$erate' where FIXED='$fixed' ";
